# -*- coding: utf-8 -*-
"""
Created on Mon Jun 17 15:16:27 2019
...
df = df1[df1['产品名称'].str.contains('钻石酒店' )]
...
F =  pd.DataFrame(dfsj.resample('D').sum().to_period('D'))
F.reset_index(inplace=True)
#dfsj.to_excel(r'C:\Users\41223\Desktop\网络数据分析\导出\微信门票.xlsx',index=False) 

#print(dfsj.resample('D').sum().to_period('D'))  